...
- LangGraph · LangChain · LlamaIndex · ADK · A2A · OpenAI APIs

**Search & Retrieval**
- ElasticSearch · OpenSearch · Vector Stores · Hybrid Retrieval · Embeddings

**Data Pipelines**
- LlamaIndex Ingestion Pipelines · Document Stores · Chunking · Metadata Modeling

**Backend & UI**
- FastAPI · React · REST APIs

**ML / NLP**
- Python · SentenceTransformers · Time-Series Analytics · PDF / JSON Loaders
...
- Iterative research & planning loops
- Semantic and hybrid search (dense + sparse)
- State-driven execution graphs
- Document intelligence & indexing
- Multimodal data processing (structured + unstructured)
- Domain-specific reasoning (Finance, Travel, News)
...
- Research Agents & Analytical Workflows
...
- Memory architectures for persistent agents
- Tool & API-rich research agents
- Planning + Critique + Reflection loops
- Enterprise RAG & multi-source knowledge systems
